  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4 sm:px-6 md:px-8">
      <div className="w-full max-w-md sm:max-w-md md:max-w-lg lg:max-w-xl 2xl:max-w-2xl bg-white p-6 sm:p-8 md:p-10 rounded-xl shadow-lg border border-gray-200">
        {/* Heading */}
        <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-2">
          Log In
        </h2>
        ...
        {/* Form */}
        <Form ref={formRef} onSubmit={submitHandler} className="flex flex-col gap-4">
          {/* Email */}
          <label htmlFor="email" className="flex flex-col text-gray-700 text-sm sm:text-base md:text-base">
            ...
            <input
              ...
              className="mt-1 p-3 sm:p-4 md:p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50"
            />
          </label>
          ...
          <label htmlFor="password" className="flex flex-col text-gray-700 text-sm sm:text-base md:text-base relative">
            ...
            <input
              ...
              className="mt-1 p-3 sm:p-4 md:p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 pr-10"
            />
            <button
              type="button"
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-3 sm:py-4 md:py-4 rounded-md hover:bg-blue-700 hover:scale-105 transition-all mt-2 shadow-md"
          > Log In
          </button>
